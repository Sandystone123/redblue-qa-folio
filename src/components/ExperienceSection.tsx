      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="relative">
            <div className="absolute left-8 top-0 bottom-0 w-1 bg-gradient-to-b from-yellow-400 to-amber-300 rounded-full" />
            
            <div className="relative pl-20 pb-12">
              <div className="absolute left-6 top-8 w-6 h-6 bg-gradient-to-r from-yellow-400 to-amber-300 rounded-full border-4 border-slate-900 shadow-lg" style={{ boxShadow: '0 0 20px rgba(255, 215, 0, 0.5)' }} />
              ...
              <div className="project-card animate-fade-in-up">
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-6">
                  <div>
                    ...
                    <h4 className="text-xl text-yellow-400 font-semibold glow-text">TechTree IT Systems Pvt. Ltd.</h4>
                  </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid lg:grid-cols-2 gap-6">
                    <div className="flex items-start space-x-4">
                      <div className="w-3 h-3 bg-yellow-400 rounded-full mt-2 flex-shrink-0" style={{ boxShadow: '0 0 10px rgba(255, 215, 0, 0.8)' }} />
                    ...
                    <div className="flex items-start space-x-4">
                      <div className="w-3 h-3 bg-amber-400 rounded-full mt-2 flex-shrink-0" style={{ boxShadow: '0 0 10px rgba(251, 191, 36, 0.8)' }} />
                      <span className="text-gray-300 leading-relaxed">Identifying, documenting, and tracking bugs using tools like Jira</span>
                    </div>
                    
                    <div className="flex items-start space-x-4">
                      <div className="w-3 h-3 bg-yellow-300 rounded-full mt-2 flex-shrink-0" style={{ boxShadow: '0 0 10px rgba(253, 224, 71, 0.8)' }} />
                      <span className="text-gray-300 leading-relaxed">Collaborating closely with developers to reproduce and resolve issues</span>
                    </div>
                    
                    <div className="flex items-start space-x-4">
                      <div className="w-3 h-3 bg-amber-300 rounded-full mt-2 flex-shrink-0" style={{ boxShadow: '0 0 10px rgba(252, 211, 77, 0.8)' }} />
                    ...
                    <div className="flex items-start space-x-4 lg:col-span-2">
                      <div className="w-3 h-3 bg-yellow-500 rounded-full mt-2 flex-shrink-0" style={{ boxShadow: '0 0 10px rgba(234, 179, 8, 0.8)' }} />
