            ...
            >
              <div className="flex justify-between items-start mb-6">
                ...
                <div className="text-right">
                  <div className="text-sm text-yellow-300 mb-1">Bugs Found</div>
                  <div className="text-xl font-bold text-green-400">{project.metrics.bugs}</div>
                  <div className="text-sm text-yellow-300 mb-1">Coverage</div>
                  <div className="text-lg font-bold text-amber-400">{project.metrics.coverage}</div>
                </div>
              </div>
              ...
              <div className="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-yellow-400/20 to-amber-300/20 group-hover:from-yellow-400/50 group-hover:to-amber-300/50 transition-all duration-300" />
            </div>
          ))}
        </div>
      </div>
